...
// //Définir le lieux de stockage (à utiliser si au lieu du router.post echo "# express-et-generateur" >> README.md)
...
router.get('/unfichier', function (req, res, next) {
...
router.post('/unfichier', upload.single('monfichier'), function (req, res) {
...
/*Mise en place du formulaire */
router.get('/desfichiers', function (req, res, next) {
...
router.post('/desfichiers', upload.array('mesfichiers', 3), function (req, res) {
  res.send(req.files)
